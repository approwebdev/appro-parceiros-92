...
-- Inserir alguns dados de exemplo usando categorias válidas
INSERT INTO public.treatments (name, description, subtitle, category, base_price, button_color) VALUES 
('Corte Masculino', 'Corte moderno e estiloso para homens', 'Estilo e personalidade', 'transformation', 35.00, '#D4AF37'),
('Coloração', 'Coloração profissional com produtos de qualidade', 'Transforme seu visual', 'transformation', 80.00, '#8B4513'),
('Hidratação Capilar', 'Tratamento intensivo para cabelos ressecados', 'Nutrição e brilho', 'treatment', 45.00, '#228B22');
