...
const SalonFinder = () => {
  ...
  return <div className="min-h-screen bg-white text-gray-900 overflow-y-auto">
      ...
      {/* Background Image */}
      <div 
        className="absolute top-[72px] left-0 right-0 h-96 opacity-15 pointer-events-none z-0"
        style={{
      ...
      <div className="px-4 py-8 max-w-md mx-auto md:max-w-4xl md:px-8 relative z-10">
        ...
        <div className="h-96 md:h-[500px] lg:h-[600px] bg-contain bg-center bg-no-repeat rounded-lg -mb-24 relative z-10" style={{
